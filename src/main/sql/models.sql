...
CREATE TABLE IF NOT EXISTS "NotificationUser" (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (id_message) REFERENCES "Message"(id) ON DELETE CASCADE ON UPDATE CASCADE,     --TODO ON DELETE SET NULL or CASCADE?
    FOREIGN KEY (id_reservation) REFERENCES "Reservation"(id) ON DELETE SET NULL ON UPDATE CASCADE,    --TODO ON DELETE SET NULL or CASCADE?
    FOREIGN KEY (id_user) REFERENCES "User"(id) ON DELETE CASCADE ON UPDATE CASCADE
